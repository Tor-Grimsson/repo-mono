/**
 * Table - Standalone data table component
 *
 * Structured table with column configuration and row rendering.
 * Requires table.css for styling. Tokens can be overridden via CSS custom properties.
 *
 * @param {Object} props

...
// ================================================================
// Portrait 2160×3600, 600f/20s @30fps
// Same dealer's choice animation as V3: orbiting halves + undulating waves
// ================================================================

export const HamburgerV4: React.FC = () => {
  ...
  const orbitAngle = orbitProgress * Math.PI * 3;
  const orbitDampen = splitAmount;
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      ...
      >
        ...
        >
          <defs>
            <clipPath id="clip-top-v4">
              <rect x={-R - 20} y={-R - 20} width={R * 2 + 40} height={R + 20} />
            </clipPath>
            <clipPath id="clip-bottom-v4">

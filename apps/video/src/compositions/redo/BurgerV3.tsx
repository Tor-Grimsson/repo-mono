...
// ================================================================
// Burger V3 — Creative Variant, 1920×1080, 600 frames (20s @ 30fps)
// ================================================================
// Slow global rotation. Halves counter-tilt as they separate.
// Waves draw on from alternating sides. Glow pulse on waves.
// More organic, breathing motion throughout.
// ================================================================

const WAVE_ORDER = [1, 0, 2]; // center, top, bottom

export const BurgerV3: React.FC = () => {
  ...
  // ---- Half tilt: counter-rotate as they separate ----
  const halfTilt = gap * 6; // degrees

  // ---- Breathing: continuous gentle pulse ----
  ...
  // Alternating draw direction: odd waves draw from left, even from right
  // Achieved by using negative strokeDashoffset for one direction
  const waveDrawDir = (i: number) => (i % 2 === 0 ? 1 : -1);

  // Wave horizontal drift — more pronounced than V1
    ...
    <AbsoluteFill style={{ backgroundColor: BG }}>
      ...
      >
        ...
        >
          ...
          {/* Bottom half — counter-rotates opposite */}

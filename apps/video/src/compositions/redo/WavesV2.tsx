...
// ================================================================
// Waves V2 — Portrait 2160×3600, 450 frames (15s @ 30fps)
// Same animation as Waves V1, portrait canvas.
// ================================================================

const WAVE_ORDER = [1, 0, 2];

export const WavesV2: React.FC = () => {
  ...
  // Portrait scale
  const compositeScale = 4.5 * introScale * outroScale * pulse;

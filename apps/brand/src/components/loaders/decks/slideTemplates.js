...
export const COVER_TEMPLATE = [
  ...
  { type: 'text', text: 'KV', color: 'palette:light',
...
export const END_TEMPLATE = [
  ...
  { type: 'text', text: 'kolkrabbi · com', color: 'palette:accent',

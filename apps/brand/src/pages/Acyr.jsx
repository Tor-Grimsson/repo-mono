...
const TokenName = ({ children }) => <code className="kol-helper-12 text-emphasis">{children}</code>
...
const mediaInventoryCols = [
  { accessor: 'surface',      header: 'Surface',          render: (r) => <span className="text-emphasis">{r.surface}</span> },

...
import { documentationInventory } from '../../data/styleguide/documentationInventory'
    ...
    return (
      <div className="space-y-8">
        ...
        <p className="kol-mono-xs">
          <Link to="/styleguide/design-system/documentation" className="text-accent-primary">
      ...
      <DocsLayout>
                    ...
                    <ul className="space-y-1">
                      {docs.map((d) => {
                        ...
                        return (
                          <li key={d.id}>
                            <Link
                              to={`/styleguide/design-system/documentation/${d.id}`}
        ...
        <DocsTocColumn className="text-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Link
                to="/styleguide/design-system/documentation"

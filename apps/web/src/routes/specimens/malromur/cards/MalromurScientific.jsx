export default function SpecimenFour() {
  return (
    <div className="w-full min-h-screen relative bg-surface">
      ...
      <section className="w-full min-h-screen flex items-center justify-center px-8 py-24 bg-surface-inverse">
        <div className="max-w-[900px] mx-auto text-center space-y-8">
          ...
          <div className="space-y-6 text-auto text-base font-['TGMalromur'] leading-6">
            <p>
      ...
      <section className="w-full px-8 py-24">
        <div className="max-w-[800px] mx-auto">
          {/* Abstract */}
          <div className="text-center mb-16 pb-8 border-b-2 border-auto">
            <h2 className="text-auto text-[20px] font-medium font-['TGMalromur'] leading-[28px] mb-6 uppercase tracking-wide">
              Abstract
            </h2>
            <p className="text-auto text-[18px] font-normal font-['TGMalromur'] leading-[28px] text-justify">
          ...
          <div className="text-center mb-12">
            <h1 className="text-auto text-[48px] font-medium font-['TGMalromur'] leading-[56px] mb-6">
              The Fallacy of the Null‑Hypothesis Significance Test
            </h1>
            <p className="text-auto text-[20px] font-normal font-['TGMalromur'] leading-[28px] mb-2">
              William W. Rozeboom, St. Olaf College
            </p>
            <p className="text-auto text-[18px] font-normal font-['TGMalromur'] leading-[28px] italic">
          ...
          {/* Case Study Section */}
          <div className="mb-12 pt-8 border-t border-auto">
            <h2 className="text-auto text-[32px] font-medium font-['TGMalromur'] leading-[40px] text-center mb-8">
              A Case Study in Null‑Hypothesis Procedure
            </h2>
            <h3 className="text-auto text-[20px] font-normal font-['TGMalromur'] leading-[28px] italic text-center mb-8">
          ...
          {/* Data Table */}
          <div className="mb-12 bg-surface-inverse p-8 rounded">
            <h3 className="text-auto text-[32px] font-medium font-['TGMalromur'] leading-[40px] mb-6 text-center">
              Experimental Results
            </h3>

            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-auto">
                  <th className="text-left py-3 px-4 text-auto text-[16px] font-medium font-['TGMalromur'] leading-[24px]">Group</th>
                  <th className="text-center py-3 px-4 text-auto text-[16px] font-medium font-['TGMalromur'] leading-[24px]">N</th>
                  <th className="text-center py-3 px-4 text-auto text-[16px] font-medium font-['TGMalromur'] leading-[24px]">Mean</th>
                  <th className="text-center py-3 px-4 text-auto text-[16px] font-medium font-['TGMalromur'] leading-[24px]">SD</th>
                  <th className="text-center py-3 px-4 text-auto text-[16px] font-medium font-['TGMalromur'] leading-[24px]">t</th>
                  <th className="text-center py-3 px-4 text-auto text-[16px] font-medium font-['TGMalromur'] leading-[24px]">p</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-auto/20">
                  <td className="py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">Experimental</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">150</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">47.3</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">12.8</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px] italic" rowSpan="2">2.34</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px] italic" rowSpan="2">&lt; 0.02</td>
                </tr>
                <tr className="border-b border-auto/20">
                  <td className="py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px] italic">Control</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">150</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">43.1</td>
                  <td className="text-center py-3 px-4 text-auto text-[16px] font-normal font-['TGMalromur'] leading-[24px]">13.2</td>
                </tr>
              </tbody>
            </table>

            <p className="mt-4 text-auto text-[14px] font-normal font-['TGMalromur'] leading-[20px] italic">
          ...
          {/* Discussion */}
          <div className="space-y-6 mb-12">
            <h2 className="text-auto text-[32px] font-medium font-['TGMalromur'] leading-[40px] mb-6">
              Discussion
            </h2>
          ...
          {/* Conclusion */}
          <div className="pt-8 border-t-2 border-auto">
            <h2 className="text-auto text-[32px] font-medium font-['TGMalromur'] leading-[40px] mb-6">
              Conclusion
            </h2>

            <p className="text-auto text-[18px] font-normal font-['TGMalromur'] leading-[28px] text-justify mb-6">
          ...
          {/* Footer */}
          <div className="text-center pt-12 border-t border-auto mt-12">

    ...
    <div className="w-full min-h-screen relative bg-white">
      ...
      <section className="w-full min-h-screen flex items-center justify-center px-8 py-24 bg-[#F5F1E8]">
        <div className="max-w-[900px] mx-auto text-center space-y-8">
          ...
          <div className="space-y-6 text-black text-base font-['TGMalromur'] leading-6">
            <p>
      ...
      <section className="w-full px-8 py-24">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center mb-16 pb-8 border-b-2 border-black">
            <h2 className="text-black text-[20px] font-medium font-['TGMalromur'] leading-[28px] mb-6 uppercase tracking-wide">
              Abstract
            </h2>
            <p className="text-black text-[18px] font-normal font-['TGMalromur'] leading-[28px] text-justify">
          ...
          <div className="text-center mb-12">
            <h1 className="text-black text-[48px] font-medium font-['TGMalromur'] leading-[56px] mb-6">
              The Fallacy of the Null‑Hypothesis Significance Test
            </h1>
            <p className="text-black text-[20px] font-normal font-['TGMalromur'] leading-[28px] mb-2">
              William W. Rozeboom, St. Olaf College
            </p>
            <p className="text-black text-[18px] font-normal font-['TGMalromur'] leading-[28px] italic">
          ...
          <div className="mb-12 pt-8 border-t border-black">
            <h2 className="text-black text-[32px] font-medium font-['TGMalromur'] leading-[40px] text-center mb-8">
              A Case Study in Null‑Hypothesis Procedure
            </h2>
            <h3 className="text-black text-[20px] font-normal font-['TGMalromur'] leading-[28px] italic text-center mb-8">
          ...
          <div className="mb-12 bg-[#F5F1E8] p-8 rounded">
            <h3 className="text-black text-[32px] font-medium font-['TGMalromur'] leading-[40px] mb-6 text-center">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-black">
                  <th className="text-left py-3 px-4 text-black text-[16px] font-medium font-['TGMalromur'] leading-[24px]">Group</th>
                  <th className="text-center py-3 px-4 text-black text-[16px] font-medium font-['TGMalromur'] leading-[24px]">N</th>
                  <th className="text-center py-3 px-4 text-black text-[16px] font-medium font-['TGMalromur'] leading-[24px]">Mean</th>
                  <th className="text-center py-3 px-4 text-black text-[16px] font-medium font-['TGMalromur'] leading-[24px]">SD</th>
                  <th className="text-center py-3 px-4 text-black text-[16px] font-medium font-['TGMalromur'] leading-[24px]">t</th>
                  <th className="text-center py-3 px-4 text-black text-[16px] font-medium font-['TGMalromur'] leading-[24px]">p</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-black/20">
                  <td className="py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">Experimental</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">150</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">47.3</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">12.8</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px] italic" rowSpan="2">2.34</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px] italic" rowSpan="2">&lt; 0.02</td>
                </tr>
                <tr className="border-b border-black/20">
                  <td className="py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px] italic">Control</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">150</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">43.1</td>
                  <td className="text-center py-3 px-4 text-black text-[16px] font-normal font-['TGMalromur'] leading-[24px]">13.2</td>
                </tr>
              </tbody>
            </table>

            <p className="mt-4 text-black text-[14px] font-normal font-['TGMalromur'] leading-[20px] italic">
          ...
          {/* Discussion */}
          <div className="space-y-6 mb-12">
            <h2 className="text-black text-[32px] font-medium font-['TGMalromur'] leading-[40px] mb-6">
              Discussion
            </h2>
          ...
          <div className="pt-8 border-t-2 border-black">
            ...
            <p className="text-black text-[18px] font-normal font-['TGMalromur'] leading-[28px] text-justify mb-6">

export default function SpecimenThree() {
  return (
    <div className="w-full min-h-screen relative bg-[#F5F1E8]">
      ...
      <section className="w-full min-h-screen px-8 py-24">
        <div className="max-w-[1000px] mx-auto">
          <h2 className="text-auto text-3xl font-normal font-['TGMalromur'] leading-10 mb-8">
      ...
      <section className="w-full min-h-[50vh] flex items-center justify-center px-8">
        <div className="max-w-[640px] mx-auto text-center space-y-6">
          <div className="w-32 h-[1px] bg-surface-inverse mx-auto mb-8" />
          <p className="text-auto text-sm font-normal font-['TGMalromur'] leading-6">
            End of specimens
          </p>
          <p className="text-auto text-xs font-normal font-['TGMalromur'] italic leading-5">

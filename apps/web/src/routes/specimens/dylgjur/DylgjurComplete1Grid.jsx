...
export default function DylgjurComplete1Grid() {
  ...
  return (
    <div className="w-full min-h-screen relative">
      ...
      <section className="w-full min-h-screen bg-black py-16 flex items-center justify-center" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full h-full flex flex-col justify-between" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          {/* Header */}
          ...
          {/* Center content */}
          <div className="col-span-12 flex flex-col items-center justify-center space-y-8 py-32">
      ...
      <section className="w-full min-h-screen bg-white py-24 flex items-center justify-center" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          <div className="col-span-12 grid grid-rows-4 gap-0 border-2 border-black">
            {/* Row 1 */}
      ...
      <section className="w-full min-h-screen bg-black py-24 flex items-center justify-center" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          ...
          <div className="col-span-12 md:col-span-8 md:col-start-3 space-y-8 text-white font-['TGDylgjur']">
      ...
      <section className="w-full min-h-screen bg-black py-24 flex items-center justify-center" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          <div className="col-span-12 md:col-span-8 md:col-start-3 space-y-10 text-white font-['TGDylgjur']">
      ...
      <section className="w-full min-h-screen bg-white py-24 flex items-center justify-center" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          <div className="col-span-12 md:col-span-8 md:col-start-3 space-y-8 text-black font-['TGDylgjur']">
            <p className="text-[clamp(50px,6vw,96px)] leading-tight" style={{ fontWeight: 300 }}>
              makráður
            </p>
            <p className="text-[clamp(50px,6vw,96px)] leading-tight" style={{ fontWeight: 300 }}>
      ...
      <section className="w-full min-h-screen bg-white py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          <div className="col-span-12 grid grid-cols-2 gap-x-12 gap-y-6 text-black font-['TGDylgjur']">
      ...
      <section className="w-full min-h-screen bg-white py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full relative" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          ...
          <div className="col-span-12 md:col-span-8 md:col-start-3 relative z-10 space-y-6 text-black font-['TGDylgjur']">
      ...
      <section className="w-full min-h-screen bg-white py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          ...
          <div className="col-span-12 md:col-span-10 md:col-start-2 space-y-8 text-black font-['TGDylgjur']" style={{ fontWeight: 300 }}>
      ...
      <section className="w-full min-h-screen bg-black py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          ...
          <div className="col-span-12 md:col-span-10 md:col-start-2 space-y-12 text-white font-['TGDylgjur']">
      ...
      <section className="w-full min-h-screen bg-white py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          {/* Poem - final section */}
          <div className="col-span-12 md:col-span-10 md:col-start-2 space-y-10 text-black font-['TGDylgjur']">
      ...
      <section className="w-full min-h-screen bg-white py-24 flex items-center justify-center relative" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          {/* Header */}
          <div className="col-span-12 flex justify-between mb-16">
            <p className="text-black text-sm font-['TGMalromur'] uppercase tracking-wider opacity-70">
              MMXXV
            </p>
            <p className="text-black text-sm font-['TGMalromur'] uppercase tracking-wider opacity-70">
      ...
      <section className="w-full min-h-screen bg-black py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          {/* Poem - Swiss grid with expressionist line breaks */}
          <div className="col-span-12 md:col-span-10 md:col-start-2 space-y-8 text-white font-['TGDylgjur']" style={{ fontWeight: 300 }}>
            <p className="text-[clamp(40px,5vw,72px)] leading-tight" style={{ fontWeight: 700 }}>
              Að tikka er sama og að haka
            </p>
            <p className="text-[clamp(32px,4vw,56px)] leading-tight text-justify">
      ...
      <section className="w-full min-h-screen bg-white py-24" style={{ paddingLeft: `${marginX}px`, paddingRight: `${marginX}px` }}>
        <div className="w-full" style={{ display: 'grid', gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: `${gutter}px` }}>
          <div className="col-span-12 grid grid-rows-5 gap-0 border-2 border-black">
            {/* Row 1 */}

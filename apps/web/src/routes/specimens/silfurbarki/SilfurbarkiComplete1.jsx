export default function SilfurbarkiComplete1() {
  return (
    <div className="w-full min-h-screen relative">

      {/* PAGE 1: TITLE PAGE - BLACK METAL AESTHETIC - DARK */}
      <section className="w-full min-h-screen bg-surface-inverse px-8 py-16 flex items-center justify-center relative overflow-hidden">
        <div className="max-w-[1400px] w-full h-full flex flex-col justify-center items-center relative z-10">
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-12 py-24 flex items-center justify-center">
        <div className="max-w-[1200px] w-full">
          {/* Decorative drop cap and two-column layout */}
          ...
          {/* Footer annotation */}
          <div className="mt-16 border-t border-auto opacity-20 pt-4">
      ...
      <section className="w-full min-h-screen bg-surface-inverse px-8 py-24 flex items-center justify-center relative">
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full border-4 border-auto p-12 relative">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-12 py-24 flex items-center justify-center">
        <div className="max-w-[900px] w-full">
          {/* Manuscript page */}
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[800px] w-full">
          <div className="border-2 border-auto-inverse p-16 text-center space-y-12">
            {/* Ornamental top */}
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-16 flex items-center justify-center relative">

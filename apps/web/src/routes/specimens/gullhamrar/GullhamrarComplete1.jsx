export default function GullhamrarComplete1() {
  return (
    <div className="w-full min-h-screen relative">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full">
          ...
          <div className="space-y-10 text-white font-['TGGullhamrar']">
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full">
          ...
          <div className="space-y-10 text-black font-['TGGullhamrar']">
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full">
          ...
          <div className="space-y-6 text-black font-['TGGullhamrar']">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full">
          ...
          <div className="space-y-16 text-white font-['TGGullhamrar']">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-16 flex items-center justify-center">
        <div className="max-w-[1000px] w-full h-full relative">
          <div className="absolute top-16 left-0 right-0 flex justify-between">
            <p className="text-white text-sm font-['TGMalromur'] uppercase tracking-wider opacity-70">MMXXV</p>
            <p className="text-white text-sm font-['TGMalromur'] uppercase tracking-wider opacity-70">TG Gullhamrar</p>
            <p className="text-white text-sm font-['TGMalromur'] uppercase tracking-wider opacity-70">2025</p>
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-24">
        <div className="max-w-[1200px] mx-auto relative">
          ...
          <div className="relative z-10 space-y-6 text-black font-['TGGullhamrar']">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full relative">
          ...
          <div className="space-y-6 text-white font-['TGGullhamrar'] pt-24">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-24 flex items-center justify-center">
        <div className="max-w-[1000px] w-full relative">
          <div className="space-y-6 text-white font-['TGGullhamrar']">
      ...
      {/* PAGE 23: POEM PAGE 1 - LIGHT - Replace repetitive alphabet */}
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-24">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="space-y-8 text-black font-['TGGullhamrar']" style={{ fontWeight: 300 }}>
      ...
      <section className="w-full min-h-screen bg-[#f5f1e8] px-8 py-16 flex items-center justify-center">
        <div className="max-w-[1400px] w-full">
          <div className="space-y-16 text-black font-['TGGullhamrar']">
      ...
      <section className="w-full min-h-screen bg-[#1a1d23] px-8 py-24">
        <div className="max-w-[900px] mx-auto">
          <div className="space-y-12 text-white font-['TGGullhamrar']">
            <p className="text-[clamp(36px,4.5vw,64px)] leading-tight" style={{ fontWeight: 400 }}>
              og situr þar.<br />
              Var þetta gagnlegt?
            </p>

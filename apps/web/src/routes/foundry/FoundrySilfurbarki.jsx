        ...
        <section className="w-full px-8 py-24 lg:py-32">
          <div className="max-w-[1400px] mx-auto text-center">
            <h1
              ...
              style={{ fontFamily: 'TGSilfurbarki', fontWeight: 400 }}
            >
              Silfurbarki
            </h1>
            <p className="kol-text-lg text-fg-64 max-w-[600px] mx-auto">
              Silver Bark — Display typeface for those with a voice like silver
            </p>
          </div>
        </section>
...
export default FoundrySilfurbarki

  ...
  return (
    <div ref={wrapperRef} className="w-full">
      <div ref={containerRef} className="w-full">
        <div
          ref={textRef}
          className={`text-auto ${weight} ${italic ? 'italic' : 'not-italic'} font-['TGRoot'] leading-none whitespace-nowrap ${transform || ''}`}
          style={{ display: 'block' }}
        >
          {text}
        </div>
...
export default function RotVariableAxis() {
  const words = [
    { text: 'Blóta', weight: 'font-bold', italic: false },
    { text: 'Þunnur', weight: 'font-thin', italic: false },
    { text: 'Refir', weight: 'font-black', italic: false },
    { text: 'Léttur', weight: 'font-light', italic: false },
    { text: 'Áföllum', weight: 'font-semibold', italic: false },
    { text: 'Tíður', weight: 'font-normal', italic: false },
    { text: 'Ranadýra', weight: 'font-medium', italic: false },
    { text: 'Djarfur', weight: 'font-bold', italic: false },
    { text: 'Alsjáandi', weight: 'font-extrabold', italic: false },
    { text: 'Þykkur', weight: 'font-black', italic: false },
    { text: 'Sporðskjulaga', weight: 'font-semibold', italic: false },
    { text: 'Ráðstefnur', weight: 'font-normal', italic: false },
    { text: 'Djarfur', weight: 'font-black', italic: false },
  ]

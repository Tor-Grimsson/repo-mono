  ...
  return (
    <>
      <SEO
        ...
        ogImage={`${cdnBase}/foundry-typefaces/03-dylgjur/specimen-dylgjur/01-specimen-hero/specimen-hero-1200.jpg`}
        ...
        <section className="w-full py-16">
          <div className="max-w-[1400px] mx-auto">
            <div className="relative w-full h-[440px] md:h-[640px] rounded overflow-hidden bg-container-primary flex items-center justify-center border border-fg-08">
              <img
                src={`${cdnBase}/foundry-typefaces/03-dylgjur/specimen-dylgjur/01-specimen-hero/specimen-hero-1600.jpg`}
        ...
        <section className="w-full h-[720px] flex items-center">
          <div className="max-w-[1400px] mx-auto">
            <FoundryFeatureSection
              ...
              graphic={<img src={`${cdnBase}/foundry-typefaces/03-dylgjur/card-dylgjur/01-card/specimen-card-1200.jpg`} alt="Dylgjur specimen" className="w-full aspect-[10/6] rounded object-cover border border-fg-08" />}
            />
          </div>
        </section>
        ...
        <section className="w-full h-[720px] flex items-center">
          <div className="max-w-[1400px] mx-auto">
            <FoundryFeatureSection
              ...
              graphic={<img src={`${cdnBase}/foundry-typefaces/03-dylgjur/card-dylgjur/02-card/specimen-card-1200.jpg`} alt="Dylgjur specifications" className="w-full aspect-[10/6] rounded object-cover border border-fg-08" />}
            />
          </div>
        </section>

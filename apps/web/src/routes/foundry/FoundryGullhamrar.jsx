        ...
        <section className="w-full px-8 py-24 lg:py-32">
          <div className="max-w-[1400px] mx-auto text-center">
            <h1
              ...
              style={{ fontFamily: 'TGGullhamrar', fontWeight: weight }}
            >
              Gullhamrar
            </h1>
            <p className="kol-text-lg text-fg-64 max-w-[600px] mx-auto">
              Compliment — Variable weight typeface with warm, graceful forms
            </p>
          </div>
        </section>
                ...
                {weights.map((w) => (
                  ...
                  >
                    <div
                      ...
                      style={{ fontFamily: 'TGGullhamrar', fontWeight: w.value }}
                    >
                      Aa
                    </div>
...
export default FoundryGullhamrar

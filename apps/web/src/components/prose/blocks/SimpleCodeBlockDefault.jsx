...
const SimpleCodeBlockDefault = ({ value }) => {
  ...
  return (
    <div className="simple-code-block-default">
      {filename && <div className="simple-code-header-default">{filename}</div>}
      <div className="simple-code-inner-default">
        <SyntaxHighlighter
        ...
        <button
          className="simple-copy-button-default"
          onClick={handleCopy}
...
export default SimpleCodeBlockDefault

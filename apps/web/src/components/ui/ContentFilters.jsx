/* Vendored from @kolkrabbi/kol-component 0.12.19 (2026-07-28) — web owns this
 * composition surface; atoms stay package imports. DS copy serves other consumers. */
import { useState, useMemo, useRef, useEffect } from 'react'
import { Tag, Divider, Button, ViewToggle } from '@kolkrabbi/kol-component'
    ...
    <div className="w-full" style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-6">
          <h2><SectionTitle icon={titleIcon}>{title}</SectionTitle></h2>
          <Divider variant="vertical" className="self-stretch py-1" />
          <div className="flex items-center gap-1">
            <button
              type="button"
              onClick={() => setIsExpanded(!isExpanded)}
              className="kol-btn kol-btn-md kol-btn-icon text-fg-80"
            ...
            >
              <span
                className="kol-btn kol-btn-md kol-btn-icon text-fg-80 flex items-center justify-center flex-shrink-0"
                style={{

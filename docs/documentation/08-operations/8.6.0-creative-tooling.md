...
**What it does:** AI image generation using KOL art print CDN assets as style references. Generates new art remixing the visual DNA of existing prints.
...
- [1.6.0 Dev Servers](../01-foundation/1.6.0-dev-servers.md) — All dev server ports, commands, bundlers
- [8.5.0 External Integrations](8.5.0-integrations.md) — Umami, Neon, Backblaze

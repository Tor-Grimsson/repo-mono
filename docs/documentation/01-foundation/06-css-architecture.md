...
- [2.1.0 Design System: Colors](01-colors.md) - Color tokens and theming
- [2.2.0 Design System: Typography](03-typography.md) - Typography implementation

- [6.1.0 Research: Data Tables](01-data-tables.md) - Accessibility patterns
- [6.2.0 Research: Typography](02-typography.md) - Typography scale and harmonic philosophy

- [Foundation: Repository Structure](01-repository-structure.md) - Monorepo architecture
- [Foundation: Naming Conventions](02-naming-conventions.md) - Naming standards

- 4.0-css-architecture.md - Original implementation (legacy)
...
- v1.3.0 (2026-02-21): Moved from 02-design-system to 01-foundation where it belongs

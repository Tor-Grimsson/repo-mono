...
---
> This document describes the 2.1.0 color system implementation. For the evolution from 2.0.0 to 3.x, see [2.0.0 Design System Overview](2.0.0-design-system-index.md). For subsequent enhancements, see [2.2.0 Design System: Typography](2.2.0-typography.md) and [2.3.0 Design System: Breakpoints](2.3.0-breakpoints.md).
...
> **The `--kol-opacity-hex-*` family was removed (2026-05-27)** and replaced by the **`oq` opaque scale** — the solid mirror of `--kol-fg-*`: same 14 stops, `color-mix()` of the ink onto the **surface** instead of `transparent`, so it's opaque where `fg` is alpha. Auto-themes (no hardcoded light/dark). Classes: `bg-oq-*` / `text-oq-*` / `border-oq-*` (+ `-inverse`, + `hover:`), defined in `packages/theme/kol-opaque.css`. Full reference: [2.1.1 Color Cheat Sheet](./2.1.1-colors-cheat-sheet.md).
>
...
- [2.0.0 Design System Overview](2.0.0-design-system-index.md) - Previous version overview and system foundation
- [2.2.0 Design System: Typography](2.2.0-typography.md) - Typography implementation following color system patterns
- [2.3.0 Design System: Breakpoints](2.3.0-breakpoints.md) - Responsive tiers and layout patterns
- [1.3.0 Foundation: CSS Architecture](../01-foundation/1.3.0-css-architecture.md) - Layer model and component architecture
...
### Research Foundation
- [6.1.0 Research: Data Tables](7.1.0-data-tables.md) - Color usage in data contexts

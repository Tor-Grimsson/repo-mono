...
---
> This document describes the 2.1.0 color system implementation. For the evolution from 2.0.0 to 3.x, see [2.0.0 Design System Overview](2.0.0-design-system-index.md). For subsequent enhancements, see [2.2.0 Design System: Typography](2.2.0-typography.md) and [2.3.0 Design System: Components](2.3.0-css-architecture.md).
...
- [2.3.0 Design System: Components](2.3.0-css-architecture.md) - Component architecture using color system

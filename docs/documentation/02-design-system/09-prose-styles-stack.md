...
| Variant | Class | Width (ch) | Width (~rem) | Width (~px) | Primary Use |
|---------|-------|------------|--------------|-------------|-------------|
| Standard | `.kol-prose` | 65ch | 65rem | ~1040px | Documentation, articles, long-form narratives |
| Wide | `.kol-prose-wide` | 90ch | 90rem | ~1440px | Hero and marketing stories with dramatic typography |
| Compact | `.kol-prose-compact` | 45ch | 45rem | ~720px | Sidebars, supporting callouts, narrow layouts |

All wrappers snap to the 8px baseline grid and inherit semantic colors from their parent surface.

## Element Measurement Tables

> All size conversions assume a 16px root `font-size`. Line height (LH) values are listed with both px and the resulting `em` ratio to make fluid calculations straightforward.

### Standard Width [.kol-prose]

| Element | Mobile (px / rem) | Desktop (px / rem) | Line Height | Notes |
|---------|-------------------|--------------------|-------------|-------|
| H1 | 48px / 3rem | 64px / 4rem | 100% (48px → 64px) | Uppercase, Right Grotesk Tight |
| H2 | 32px / 2rem | 48px / 3rem | 110% (35px → 53px) | Secondary sections |
| H3 | 24px / 1.5rem | 32px / 2rem | 120% (29px → 38px) | Subsections |
| H4 | 20px / 1.25rem | 20px / 1.25rem | 130% (26px) | Inter Tight minor heading |
| Paragraphs | 16px / 1rem | 18px / 1.125rem | 160% (26px → 29px) | Primary body |
| Lists | 16px / 1rem | 18px / 1.125rem | 160% | `ul` gets plus marker, `ol` uses `01` |
| Code Blocks | 14px / 0.875rem | 14px / 0.875rem | 150% (21px) | Mono, tertiary surface, 1.25rem padding |
| Blockquotes | Body size | Body size | inherit | Italic with 4px accent border |
| Horizontal Rule | 1px divider | 1px divider | 2rem margin | 8% foreground mix |

### Wide Width [.kol-prose-wide]

| Element | Mobile (px / rem) | Desktop (px / rem) | Line Height | Notes |
|---------|-------------------|--------------------|-------------|-------|
| H1 | 64px / 4rem | 96px / 6rem | 100% (64px → 96px) | Dramatic hero statements |
| H2 | 40px / 2.5rem | 64px / 4rem | 110% (44px → 70px) | Large section headers |
| H3 | 32px / 2rem | 48px / 3rem | 120% (38px → 58px) | Subsections |
| H4 | 24px / 1.5rem | 24px / 1.5rem | 130% (31px) | Minor heading |
| Paragraphs | 18px / 1.125rem | 20px / 1.25rem | 170% (31px → 34px) | Wider column copy |
| Lists | 18px / 1.125rem | 20px / 1.25rem | 170% | Disc / decimal markers |
| Code Blocks | 16px / 1rem | 16px / 1rem | 140% (22px) | Mono, 1.5rem padding |
| Blockquotes | Body size | Body size | inherit | 4px accent border |
| Horizontal Rule | 1px divider | 1px divider | 3rem margin | 8% foreground mix |

### Compact Width [.kol-prose-compact]

| Element | Mobile (px / rem) | Desktop (px / rem) | Line Height | Notes |
|---------|-------------------|--------------------|-------------|-------|
| H1 | 32px / 2rem | 40px / 2.5rem | 100% (32px → 40px) | Uppercase but condensed |
| H2 | 24px / 1.5rem | 32px / 2rem | 110% (26px → 35px) | Secondary sections |
| H3 | 20px / 1.25rem | 24px / 1.5rem | 120% (24px → 29px) | Subsections |
| H4 | 18px / 1.125rem | 18px / 1.125rem | 130% (23px) | Minor heading |
| Paragraphs | 14px / 0.875rem | 16px / 1rem | 160% (22px → 26px) | Narrow copy |
| Lists | 14px / 0.875rem | 16px / 1rem | 160% | Disc / decimal markers |
| Code Blocks | 12px / 0.75rem | 12px / 0.75rem | 140% (17px) | Mono, 0.875rem padding |
| Blockquotes | Body size | Body size | inherit | 3px accent border |
| Horizontal Rule | 1px divider | 1px divider | 1.5rem margin | 8% foreground mix |
...
- Standard prose: `48px → 64px`
- Wide prose: `64px → 96px`
- Compact prose: `32px → 40px`
...
- Standard prose: `16px → 18px` (160% line height)
- Wide prose: `18px → 20px` (170% line height)
- Compact prose: `14px → 16px` (160% line height)
...
- **Wide:** Disc bullets (•) for ul, decimal (1, 2) for ol
- **Compact:** Disc bullets (•) for ul, decimal (1, 2) for ol
...
- **Padding:** `0.3em × 0.2em` with `4px` border radius
...
- `.kol-caption-text` - Caption text (kol-mono-sm-regular, muted color)
...
<div class="kol-callout kol-callout-info">
  <div class="kol-callout-label">💡 Tip</div>
...
- `.kol-prose` (65ch) for most content ✅
...
- This file: `docs/documentation/02-design-system/2.4.2-prose-stack.md`
...
- [Design System: Colors](01-colors.md) - Color tokens and theming
- [Design System: Typography](03-typography.md) - Typography implementation
- [2.3.0 Design System: CSS Architecture](2.3.0-css-architecture.md) - Layer structure and organization

- [6.2.0 Research: Typography](02-typography.md) - Typography in rich text
- [6.1.0 Research: Data Tables](01-data-tables.md) - Data table patterns and accessibility

- 3.3-prose-text.md - Original implementation (legacy)
- 3.0-typography.md - Typography (legacy)
- 2.0-color-system.md - Color system (legacy)
...
- v3.4 (2025-12-03): Refiled Stack spec under 2.4.2 with measurement tables and wrapper summaries

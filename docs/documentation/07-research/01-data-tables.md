...
- [2.2.0 Design System: Typography](03-typography.md) - Typography scale reference

**Research Foundation:**
- [Research: Overview](INDEX.md) - All research documents
- [Research: Typography](02-typography.md) - Typography scale and harmonic philosophy

**Legacy References:**
- 9.1-data-table-research.md - Original research (legacy location)
- 6.1-data-table-research.md - Duplicate (legacy)
- 4.0 CSS Architecture - CSS layer structure
- 4.1 CSS Components - Component classes

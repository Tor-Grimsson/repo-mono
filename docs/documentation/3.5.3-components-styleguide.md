...
**Version:** 3.5.3
**Domain:** 3 - Components
**Category:** 5 - Complex Components
**Patch:** 3 - Stylguide System
...
3.5.1 - Frequency Modulator Apparatus
3.5.2 - Wavy Circle Editor Apparatus
3.5.3 - Design System Styleguide (this document)
```
...
- [3.5.0 - Apparatus Overview](./3.5.0-components-apparatus-overview.md)
- [2.3.0 - CSS Architecture](../2.3.0-design-system-css-architecture.md)
- [2.4.0 - Prose System](../2.4.0-design-system-prose.md)

## Changelog

- **2025-11-04** (3.5.3): Initial styleguide architecture documentation

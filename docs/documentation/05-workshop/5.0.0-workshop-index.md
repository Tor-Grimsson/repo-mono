...
| [5.6.0 Dashboard](./5.6.0-dashboard.md) | `/workshop/dashboard` | Data dashboards |
| [5.7.0 Documentation](./5.7.0-documentation.md) | `/workshop/design-system/documentation` | Internal documentation viewer |
| [5.8.0 Search Indexer](./5.8.0-search-indexer.md) | — | Keyword-based content search |
| [5.9.0 Right Sidebar](./5.9.0-right-sidebar.md) | — | TOC rail, sibling nav, default fallback |

# 2.4.2 Design System: Prose Styles — Stack
...
# Stack Prose System (v3.4)

**Purpose:** Comprehensive styling for long-form content including blog posts, articles, and rich text from CMSes. This document focuses on the three Stack wrappers (`.kol-prose`, `.kol-prose-wide`, `.kol-prose-compact`). Use [2.4.0 Styles Index](2.4.0-styles-index.md) for navigation across all prose systems.
...
**Text After Blockquote:** Paragraphs immediately following a blockquote are styled as attribution text with mono font, muted color (64% opacity), and 1rem top margin—similar to pull quote citations.
...
**Text After hr:** Paragraphs immediately following a horizontal rule are styled as transitional text with mono font, muted color (64% opacity), and 1rem top margin—consistent with text after blockquotes.

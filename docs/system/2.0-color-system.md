...
The system consists of 69 new tokens (41 light mode, 28 dark mode overrides), 14 new utility classes, and complete backward compatibility with the legacy system.
...
```css
--kol-surface-primary          /* #fcfbf8 (light) / #121215 (dark) */
--kol-surface-on-primary       /* #1e1e21 (light) / #f5f5f5 (dark) */

--kol-surface-secondary        /* #f5f5f5 (light) / #19191d (dark) */
--kol-surface-on-secondary     /* #1e1e21 (light) / #f5f5f5 (dark) */

--kol-surface-tertiary         /* #eeeeee (light) / #202026 (dark) */
--kol-surface-on-tertiary      /* #1e1e21 (light) / #f5f5f5 (dark) */

--kol-surface-inverse          /* #1e1e21 (light) / #f5f5f5 (dark) */
--kol-surface-on-inverse       /* #fcfbf8 (light) / #121215 (dark) */
...
--kol-container-on-primary     /* #1e1e21 (light) / #f5f5f5 (dark) */

--kol-container-secondary      /* #eeeeee (light) / #202026 (dark) */
--kol-container-on-secondary   /* #1e1e21 (light) / #f5f5f5 (dark) */

--kol-container-elevated       /* #fcfbf8 (light) / #121215 (dark) */
--kol-container-on-elevated    /* #1e1e21 (light) / #f5f5f5 (dark) */
```
...
**Utility classes:**
- `packages/ui/theme.css` (lines 643-943)

**Component CSS:**
- `packages/ui/css/components.css` (uses tokens)

**Legacy CSS:**
- `packages/ui/css/utilities.css` (deprecated component tokens removed)

**Documentation:**
- `docs/system/2.0-color-system.md` (this file)
- `docs/system/2.1-color-tables.md` (quick reference tables)
...
- [Typography Reference](./3.0-typography.md)
- [CSS Architecture](./4.0-css-architecture.md)
- [Styleguide Best Practices](./5.0-styleguide.md)
- [Design System Analysis](../archive/plans/design-system-analysis.md)
- [Color Tables](./2.1-color-tables.md)

**Implementation details:**
- [Color System Refactor Plan](../archive/plans/color-system-refactor-plan.md) (Phase 1-6 plan)
- [Phase 4 Session Log](../SESSION-LOGS/2025-10-16-1500-color-system-refactor-phase-4-complete.md)

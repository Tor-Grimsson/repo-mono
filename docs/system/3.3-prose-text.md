...
**Version:** 3.3 - Prose Typography & Rich Content
...
**Documentation:**
- This file: `docs/system/3.3-prose-text.md`
- Typography: `docs/system/3.0-typography.md`
- Color system: `docs/system/2.0-color-system.md`
...
- [Typography System](./3.0-typography.md) - Full typography scale reference
- [Color System](./2.0-color-system.md) - Color tokens and utilities
- [CSS Architecture](./4.0-css-architecture.md) - Layering and organization
- [Stack Article Component](./7.2.6-stack-article.md) - Implementation example
